...
ggsave(
  filename = "/Users/niyati/Projects:Codes/PhD-Compute/R code/TestPrblms/MaxSAT/n_vars=60/maxsat60_mean_objective_methods.pdf",
  plot = mean_plot,
  device = cairo_pdf,
...
time_list <- list(
  ...
  `VaRCBO` = prbocs_vb_time,
  `VaRCBO-GA` = prbocs_vb_ga_time,
