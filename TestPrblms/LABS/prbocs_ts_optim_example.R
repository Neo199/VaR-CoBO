...
thompson_sam <- function(theta_current, bayesian_model, removed_columns, data, order){
...
for (t in 1:evalBudget) {
  ...
  stat_model <- function(theta) {
    thompson_sam(theta, bayesian_model = bayesian_model, removed_columns, data, order)
  }
