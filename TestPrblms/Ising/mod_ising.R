...
source("~/Ising/sample_models.R")
source("~/Ising/thompson.R")
source("~/Ising/thompson_svb.R")
source("~/Ising/ordertheta_interaction.R")
source("~/Ising/sim_anneal.R")
source("~/Ising/semi_def_progm.R")
source("~/Ising/prbocs.R")
source("~/Ising/prbocs_vb.R")
source("~/Ising/prbocs_ga.R")
source("~/Ising/prbocs_vb_ga.R")
source("~/Ising/bocs_ga.R")
source("~/Ising/bocs_sa.R")
source("~/Ising/bocs_sdp.R")
library(GA)
library(psych)
library(lpSolve)
library(ompr)
