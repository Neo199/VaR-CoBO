...
# No constraints are actually included in the solver(only in the orignal Warehouse model)
...
source("~/Projects:Codes/PhD-Compute/R code/TestPrblms/Warehouse/Warehouse.R")
source("~/Projects:Codes/PhD-Compute/R code/TestPrblms/Warehouse/sample_models.R")
source("~/Projects:Codes/PhD-Compute/R code/TestPrblms/Warehouse/thompson.R")
source("~/Projects:Codes/PhD-Compute/R code/TestPrblms/Warehouse/thompson_svb.R")
source("~/Projects:Codes/PhD-Compute/R code/TestPrblms/Warehouse/ordertheta_interaction.R")
source("~/Projects:Codes/PhD-Compute/R code/TestPrblms/Warehouse/sim_anneal.R")
source("~/Projects:Codes/PhD-Compute/R code/TestPrblms/Warehouse/semi_def_progm.R")
source("~/Projects:Codes/PhD-Compute/R code/TestPrblms/Warehouse/prbocs.R")
source("~/Projects:Codes/PhD-Compute/R code/TestPrblms/Warehouse/prbocs_vb.R")
source("~/Projects:Codes/PhD-Compute/R code/TestPrblms/Warehouse/prbocs_ga.R")
source("~/Projects:Codes/PhD-Compute/R code/TestPrblms/Warehouse/prbocs_vb_ga.R")
source("~/Projects:Codes/PhD-Compute/R code/TestPrblms/Warehouse/bocs_ga.R")
source("~/Projects:Codes/PhD-Compute/R code/TestPrblms/Warehouse/bocs_sa.R")
source("~/Projects:Codes/PhD-Compute/R code/TestPrblms/Warehouse/bocs_sdp.R")
library(GA)
library(psych)
library(lpSolve)
library(ompr)
...
model <- function(x_vals){
  warehouse_prob(x_vals, cost_data, lambda = 1, rho = 50)
}
...
run_simulation_instance <- function(instance_id, n_vars, evalBudget, n_init, order,
  ...
  tryCatch({
    ...
    result <- list(PRBOCS = prbocs, PRBOCS_VB = prbocs_vb,
                   PRBOCS_VB_GA = prbocs_vb_ga, BOCS_SA = bocssa, GA = ga)
...
order <- 2
seed <- 1
num_instances <- 1  # number of parallel runs

# Generate problem data once (shared across all instances)
cost_data <- Generate_WLP_data(
  n_customers = 10, 
  n_warehouses = 5, 
  seed = seed
)

n_vars <- length(cost_data$f) + nrow(cost_data$C) * ncol(cost_data$C)

# --------------------------
# Run the simulation study
#---------------------------

folder_name <- paste0("ware_n_vars=", n_vars)
